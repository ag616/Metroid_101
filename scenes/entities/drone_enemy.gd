...
func _ready() -> void:
	...
	new_mat.set_shader_parameter("Color", old_mat.get_shader_parameter("Color"))
	new_mat.set_shader_parameter("Progress", old_mat.get_shader_parameter("Progress"))
	$AnimatedSprite2D.material = new_mat
